...
<div class="mb-20" style="margin-bottom: 20px;">
    ...
    <a href="join_left.php" class="btn btn-primary" style="margin-right: 5px;">LEFT JOIN</a>
...
<div class="d-flex justify-between align-center mb-20">
    <h2>Demo LEFT JOIN</h2>
</div>

<div style="background-color: #fff3cd; border-left: 5px solid #ffc107; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
    <h4 style="margin-top: 0;">Maksud dan Tujuan: LEFT JOIN</h4>
    <p style="margin-bottom: 5px;"><strong>LEFT JOIN</strong> digunakan untuk menampilkan <strong>SEMUA</strong> data dari tabel sebelah kiri (tabel utama), dan hanya menampilkan data yang cocok dari tabel sebelah kanan.</p>
    <p style="margin-bottom: 0;"><strong>Penjelasan untuk Orang Awam:</strong> Bayangkan kita memprioritaskan daftar "Anggota" sebagai tabel utama. Kita ingin melihat <strong>SEMUA Anggota</strong> tanpa terkecuali. Jika ada anggota yang belum memilih jurusan (data jurusannya kosong), mereka <strong>TETAP AKAN</strong> ditampilkan di daftar ini. Namun, jurusan yang tidak memiliki anggota tidak akan ditampilkan.</p>
</div>
